...
# ============================================================
BATCH_SIZE_OVERRIDE = config_loader.get_decompressor_batch_size()
MAX_WORKER_THREADS = config_loader.get_max_worker_threads()
GPU_FALLBACK_ENABLED = config_loader.is_gpu_fallback_enabled()
# ============================================================

# Determinar GPU_BATCH_SIZE: override fixo ou cálculo automático
if BATCH_SIZE_OVERRIDE is not None:
    GPU_BATCH_SIZE = BATCH_SIZE_OVERRIDE
    print(f"[GPU_LZ4] Batch Size FIXO (config.txt): {GPU_BATCH_SIZE} frames")
else:
    try:
